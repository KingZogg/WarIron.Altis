...
[
	["PDW2000 SMG 9mm (holo)", "hgun_PDW2000_Holo_F", 100],
	["Sting SMG 9mm", "SMG_02_F", 125],
	["Vermin SMG .45ACP", "SMG_01_F", 125]
];
...
[
	...
	// Assault Rifles
	["Mk20 Carbine 5.56mm", "arifle_Mk20C_plain_F", 150],
	["Mk20 Carbine 5.56mm (Camo)", "arifle_Mk20C_F", 150],
	["Mk20 Rifle 5.56mm", "arifle_Mk20_plain_F", 200],
	["Mk20 Rifle 5.56mm (Camo)", "arifle_Mk20_F", 200],
	["Mk20 EGLM Rifle 5.56mm (GL)", "arifle_Mk20_GL_plain_F", 250],
	["Mk20 EGLM Rifle 5.56mm (GL Camo)", "arifle_Mk20_GL_F", 250],

	["TRG-20 Carbine 5.56mm", "arifle_TRG20_F", 150],
	["TRG-21 Rifle 5.56mm ", "arifle_TRG21_F", 200],
	["TRG-21 EGLM Rifle 5.56mm", "arifle_TRG21_GL_F", 250],

	["Katiba Carbine 6.5mm", "arifle_Katiba_C_F", 150],
	["Katiba Rifle 6.5mm", "arifle_Katiba_F", 200],
	["Katiba GL Rifle 6.5mm", "arifle_Katiba_GL_F", 250],

	["MX Carbine 6.5mm", "arifle_MXC_F", 150],
	["MX Carbine 6.5mm (Black)", "arifle_MXC_Black_F", 175],
	["MX Rifle 6.5mm", "arifle_MX_F", 200],
	["MX Rifle 6.5mm (Black)", "arifle_MX_Black_F", 225],
	["MX 3GL Rifle 6.5mm", "arifle_MX_GL_F", 250],
	["MX 3GL Rifle 6.5mm (Black)", "arifle_MX_GL_Black_F", 275],
...
[
	...
	["MX SW LMG 6.6mm (Black)", "arifle_MX_SW_Black_F", 325],
	["Mk200 6.5mm LMG (with laser)", "LMG_Mk200_pointer_F", 375],                    
	["Zafir 7.62mm LMG (with laser)", "LMG_Zafir_pointer_F", 1000]					
];
...
[
	...
	["Land Pier", "Land_Pier_F", 5000, "object"]
];
...
[
	...
	["M5 Sandstorm MLRS", "B_MBT_01_mlrs_F", 105000, "vehicle"]
...
[
	...
	["UH-80 Ghost Hawk (Black)", "B_Heli_Transport_01_F", 125000, "vehicle"], // UH-60 Stealth with 2 side miniguns
	["UH-80 Ghost Hawk (Green)", "B_Heli_Transport_01_camo_F", 125000, "vehicle"], // UH-60 Stealth with 2 side miniguns (green camo)
	["CH-67 Huron (Armed) [DLC]", "B_Heli_Transport_03_F", 130000, "vehicle"], // CH-47 with 2 side miniguns
	["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 130000, "vehicle"], // Armed AH-6
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 130000, "vehicle"], // Armed Ka-60 with orca paintjob
	["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 135000, "vehicle"], // Armed Ka-60
	["WY-55 Hellcat (Armed)", "I_Heli_light_03_F", 140000, "vehicle"], // Armed AW159
	["AH-99 Blackfoot", "B_Heli_Attack_01_F", 175000, "vehicle"], // RAH-66 with gunner
	["Mi-48 Kajman (Hex)", "O_Heli_Attack_02_F", 185000, "vehicle"], // Mi-28 with gunner
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 185000, "vehicle"] // Mi-28 with gunner (black camo)
];
...
*/		
			...
			["Brown Camo", _texDir + "ant.jpg"],
			["Brown/Green Camo", _texDir + "BMW.jpg"],
			["Jungle Camo", _texDir + "camo_fuel.jpg"],
			["Pink Camo", _texDir + "camo_pink.jpg"],
			["Pink Camo", _texDir + "camo_pink_small.jpg"],
			["Rainbow", _texDir + "camo_rain.jpg"],
			["Carbon", _texDir + "carbon.jpg"],
			["Green Cloth Camo", _texDir + "clothcamo.jpg"],
			["Digital Hex Blue", _texDir + "dcamo.jpg"],
			//["Denim", _texDir + "denim.jpg"],
			["Digital Camo", _texDir + "digicam.jpg"],
			["Red Camo", _texDir + "DMR.jpg"],
			["Ice Camo", _texDir + "IceCamo.jpg"],
			["Hello Kitty", _texDir + "kitty.jpg"],
			["Leopard", _texDir + "leopard.jpg"],
			["Psycho", _texDir + "psych.jpg"],
			["Trippy", _texDir + "rainbow.jpg"],
			["Red/Black/White Camo", _texDir + "redcamo.jpg"],
			["Rusty", _texDir + "rusty.jpg"],
			["Pirate", _texDir + "skulls.jpg"],
			["Snakeskin Camo", _texDir + "snake.jpg"],
			["Brown/White/Green Camo", _texDir + "SWWD.jpg"],
			
			["Titty Touchers", _texDir + "top-boobs-1.jpg"],
			//["Pussy Patrol", _texDir + "top-pussy-1.jpg"],
									
			["Zebra", _texDir + "zebra.jpg"] // #(argb,8,8,3)color(0.546,0.59,0.363,0.2)
...
[
	["Gold Bullion", "goldbullion", "" ,"client\icons\gold.paa", 100000, 100000]
