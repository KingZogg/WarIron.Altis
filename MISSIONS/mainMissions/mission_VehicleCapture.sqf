...
_setupObjects =
{
	...
	_bunker = (call compile preprocessFileLineNumbers "\server\missions\bunkers\bunkerList.sqf") call BIS_fnc_selectRandom;
	_bunker = [_bunker, _missionPos, 0] call createBunker;
