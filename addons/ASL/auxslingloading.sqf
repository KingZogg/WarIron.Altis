...
// these can't be sling loaded yet .. put here for when BI ever make them slingable
...
]; //lift = 500 e.g. Littlebird

AuxSling_medium_config = AuxSling_light_config + AuxSling_medium_config + 
[
"Offroad_01_base_F",
"Hatchback_01_base_F",
"SUV_01_base_F",
...
"Land_CncWall4_F"
]; //lift = 4000 e.g GhostHawk


AuxSling_heavy_config = AuxSling_medium_config + AuxSling_heavy_config + 
