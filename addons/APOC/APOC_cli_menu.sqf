...
_optionVehMenu pushback [["expression", format ['["%1",%2,player] execVM "addons\APOC\APOC_cli_startAirdrop.sqf"',_type,_i]]];
...
_endVehMenu = ["Cancel", [_i+2], "", -3, [["expression", ""]], "1", "1"];
...
_optionSupMenu pushback [["expression", format ['["%1",%2,player] execVM "addons\APOC\APOC_cli_startAirdrop.sqf"',_type,_i]]];
