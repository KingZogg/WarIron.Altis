...
A3W_timeMultiplierDay = 1.5;       // Sets the speed of time between 5 AM and 8 PM (for example, 6.0 means 6 hours in-game will pass in 1 real hour)
...
A3W_atmMaxBalance = 3000000;       // Maximum amount of money that can be stored in a bank account (recommended: 1 million)
...
A3W_payrollAmount = 15000;           // Amount of money rewarded per territory on each payroll
...
A3W_sideMissionTimeout = 3*60;    // Time in seconds that a Side Mission will run for, unless completed

A3W_moneyMissionDelay = 4*60;     // Time in seconds between Money Missions
A3W_moneyMissionTimeout = 4*60;   // Time in seconds that a Money Mission will run for, unless completed

A3W_goldMissionDelay = 5*60;     // Time in seconds between Gold Missions
A3W_goldMissionTimeout = 5*60;   // Time in seconds that a Gold Mission will run for, unless completed

A3W_extraMissionDelay = 6*60;
A3W_extraMissionTimeout = 6*60;

A3W_bountyMissionDelay = 7*60;
A3W_bountyMissionTimeout = 7*60;

A3W_patrolMissionDelay = 8*60;
A3W_patrolMissionTimeout = 8*60;
/*
