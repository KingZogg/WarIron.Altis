...
private ["_goldbuyerDialog", "_Dialog", "_playerMoney", "_owner"];
_goldbuyerDialog = createDialog "goldbuyerd";

_Dialog = findDisplay goldbuyer_DIALOG;
_playerMoney = _Dialog displayCtrl goldbuyer_money;
